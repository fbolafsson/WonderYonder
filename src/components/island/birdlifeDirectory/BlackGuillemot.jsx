    ...
    return (
      <div className={ defaultStyles.pageContent }>
        ...
        <div className={ defaultStyles.pageSegment }>
          <h4>Black Guillemot (<em>Cepphus grylle</em>)</h4>
          <p>{ 'Black Guillemots are divers, diving in relatively shallow waters, using its wings to swim. They can stay under for about 2 and a half minutes. Their diet consists of fish, crustaceans and marine invertebrates.' }</p>
