    ...
    return (
      <div className={ defaultStyles.pageContent }>
        ...
        <div className={ defaultStyles.pageSegment }>
          ...
          <p>The Northern Gannet (<em>Morus bassanus</em>) is the largest seabird in the North Atlantic. The Gannet hunts fish by diving from the height into the sea and pursuing their prey underwater. They feed by flying high and circling before plunging into the sea often travelling in small groups.They can dive from 30meters (98ft), achieving speed up to 100 kilometers pr hour (62 mph) as they strike the water, enabling them to catch fish much deeper than most birds.</p>
